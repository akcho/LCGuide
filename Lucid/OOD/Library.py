...
class Librarian(Account):
  ...
  def add_book_item(self, book_item): None
  def block_member(self, member): None
  def un_block_member(self, member): None
...
class Member(Account):
  ...
  def reserve_book_item(self, book_item): None
  def increment_total_books_checkedout(self): None
  def renew_book_item(self, book_item): None
...
''' 
Reserving, Lending, Collecting Fines
'''
...
class BookLending:
  ...
  def lend_book(self, barcode, member_id): None
  def fetch_lending_details(self, barcode): None
...
class Fine:
  ...
  def collect_fine(self, member_id, days): None
